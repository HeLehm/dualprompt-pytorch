...
def get_args_parser(subparsers):
    ...
    # Head
    subparsers.add_argument('--use_mvn_head', default=False, type=bool, help='if using multivariate normal to classify in head')
    subparsers.add_argument('--mvn_head_iter', default=1, type=int, help='the number of iterations for cov and mean calculation for mvn head')
