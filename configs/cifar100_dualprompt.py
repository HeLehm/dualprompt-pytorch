...
def get_args_parser(subparsers):
    ...
    subparsers.add_argument('--g_prompt_freeze_after_first_task', default=False, type=bool, help='if freez the G-Prompt after the first task')
    ...
    subparsers.add_argument('--e_prompt_use_prev_emb', default=False, type=bool, help='if using the previous embedding for E-Prompt')
